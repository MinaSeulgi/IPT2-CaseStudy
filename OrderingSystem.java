...
public class OrderingSystem {
    ...
    public static void main(String[] args) {
        ...
        String userToppings[] = askForToppings(Integer.parseInt(userToppingQuantity));
        
        receipt(userSize, userToppingQuantity, userToppings);
    }
    ...
    private static void populateToppings() {
        toppings.put(1, "Ham");
        toppings.put(2, "Cheese");
        toppings.put(3, "Hotdog");
        toppings.put(4, "Pineapple");
        toppings.put(5, "Mushroom");
        toppings.put(6, "Red Onion");
        toppings.put(7, "Pepperoni");
    }
    ...
    private static void receipt(String size, String quantity, String[] toppings) {
        System.out.println("\n\n=== ORDER SLIP ===");
        System.out.println("SIZE: " + size);
        System.out.println("NO. OF TOPPINGS: " + quantity);
